  ...
  const drawer = (
    <div>
      ...
      <Link style={{textDecoration: 'none', color: 'Black'}} to="/home">
        <Button color="inherit">Home</Button><br/>
      </Link>
      {
      ...
      <Link style={{textDecoration: 'none', color: 'Black'}} to="/myOrders">
      ...
      {admin && <Box>
        ...
        <Link style={{textDecoration: 'none', color: 'Black'}} to='/manageAllProducts'>
